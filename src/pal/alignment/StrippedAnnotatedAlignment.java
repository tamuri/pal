...
public class StrippedAnnotatedAlignment extends StrippedAlignment implements AnnotationAlignment {
    ...
    public float getChromosomePosition(int site) {
        return rawAlignment.getChromosomePosition(alias[site]);
    }
    ...
    public int getChromosome(int site) {
        return rawAlignment.getChromosome(alias[site]);
    }
    ...
    public float getWeightedLocusPosition(int site) {
        return rawAlignment.getWeightedLocusPosition(alias[site]);
    }
    ...
    public int getLocusPosition(int site) {
        return rawAlignment.getLocusPosition(alias[site]);
    }
    ...
    public char getPositionType(int site) {
        return rawAlignment.getPositionType(alias[site]);
    }
    ...
    public String getLocusName(int site) {
        return rawAlignment.getLocusName(alias[site]);
    }
    ...
    public DataType getDataType(int site) {
        return rawAlignment.getDataType(alias[site]);
    }
    ...
    public void removeSitesOutsideRange(int firstSite, int lastSite) {
        ...
        for (int i = 0; i < rawAlignment.getSiteCount(); i++) {
            if ((rawAlignment.getLocusPosition(i) < firstSite) || (rawAlignment.getLocusPosition(i) > lastSite))
                dropSite(i);
        }
    }
