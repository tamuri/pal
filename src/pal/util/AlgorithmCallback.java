...
public interface AlgorithmCallback {
    ...
    final class Utils {
        ...
        private static final class PrintWriterCallback implements AlgorithmCallback {
            ...
            public void updateStatus(String statusString) {
                pw_.println("Status:" + statusString);
            }

            public void log(Object logInfo) {
                pw_.println("Log:" + logInfo);
            }
            ...
            public void updateProgress(double progress) {
                pw_.println("Progress:" + progress);
            }

            public void clearProgress() {
                pw_.println("Clear Progress");
            }
        }
        ...
        private static final class SubCallback implements AlgorithmCallback {
            ...
            public void updateStatus(String statusString) {
                parent_.updateStatus(id_ + statusString);
            }

            public boolean isPleaseStop() {
                return parent_.isPleaseStop();
            }
