...
public final class FreeBranch implements RootAccess, GeneralOptimisable {
    ...
    public FreeBranch getLeftLeftBranch() {
        return leftNode_.getLeftBranch(this);
    }
    ...
    public FreeBranch getLeftRightBranch() {
        return leftNode_.getRightBranch(this);
    }
    ...
    public FreeBranch getRightLeftBranch() {
        return rightNode_.getLeftBranch(this);
    }
    ...
    public FreeBranch getRightRightBranch() {
        return rightNode_.getRightBranch(this);
    }
    ...
    public Node buildPALNodeBase(FreeNode caller) {
        if (leftNode_ == caller) {
            return rightNode_.buildPALNodeBase(branchLength_, this);
        }
        if (rightNode_ == caller) {
            return leftNode_.buildPALNodeBase(branchLength_, this);
        }
        throw new IllegalArgumentException("Unknown caller!");
    }
    ...
    public Node buildPALNodeES(FreeNode caller) {
        if (leftNode_ == caller) {
            return rightNode_.buildPALNodeES(branchLength_, this);
        }
        if (rightNode_ == caller) {
            return leftNode_.buildPALNodeES(branchLength_, this);
        }
        throw new IllegalArgumentException("Unknown caller!");
    }
    ...
    public void testLikelihood(FreeNode caller, GeneralConstructionTool tool) {
        ...
        if (caller != leftNode_) {
            leftNode_.testLikelihood(this, tool);
        }
        if (caller != rightNode_) {
            rightNode_.testLikelihood(this, tool);
        }
    }
    ...
    public void getAllComponents(ArrayList store, Class componentType, FreeNode caller) {
        ...
        if (caller != leftNode_) {
            leftNode_.getAllComponents(store, componentType, this);
        }
        if (caller != rightNode_) {
            rightNode_.getAllComponents(store, componentType, this);
        }
    }
