...
// ==================================================================================================
    ...
    public PatternInfo getPatternInfo(GeneralConstructionTool tool, FreeBranch caller) {
        checkCaller(caller);
        return getDescendentPatternInfo(tool);
    }

    public boolean hasConnection(FreeBranch c, FreeBranch caller) {
        checkCaller(caller);
        return c == freeConnection_;
    }
...
// ============================
    public int getNumberOfOptimisationTypes() {
        return (freeConnection_ == null ? 3 : 1);
    }
...
//			System.out.println("Log likelihood:"+logLikelihood_);
        ...
        public double getLowerBound() {
            return minimumOffset_;
        }

        public double getUpperBound() {
            return maximumOffset_;
        }
    }
