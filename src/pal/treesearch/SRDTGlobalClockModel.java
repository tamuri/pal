...
// === ConstraintModel Stuff ===================================
    ...
    public NeoParameterized getGlobalParameterAccess() {
        return likelihoodModel_.getParameterAccess();
    }
...
// === GroupManagerStuff Stuff ===================================
    ...
    public int getBaseHeightUnits() {
        return sampleInformation_.getHeightUnits();
    }
...
// === NeoParameterized Stuff ==================================
    ...
    public double getLowerLimit(int n) {
        return RATE_LOWER_LIMIT;
    }

    public double getUpperLimit(int n) {
        return RATE_UPPER_LIMIT;
    }
