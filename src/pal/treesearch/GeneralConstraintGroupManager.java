...
//			System.out.println("Evaluating with :"+pal.misc.Utils.toString(argument)+"  = "+result);
        ...
        public int getNumArguments() {
            return parameterAccess_.getNumberOfParameters();
        }

        public double getLowerBound(int n) {
            return parameterAccess_.getLowerLimit(n);
        }

        public double getUpperBound(int n) {
            return parameterAccess_.getUpperLimit(n);
        }
...
// ========================================================================================
    ...
    public static final class Store {
        ...
        public final GeneralConstraintGroupManager[] getConstraintGroupManagers() {
            return constraintGroupManagers_;
        }
