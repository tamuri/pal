    ...
    public static CodonTable createTranslator(int type) {
        ...
        switch (type) {
            ...
            case CodonTable.VERTEBRATE_MITOCHONDRIAL: {
                ...
                ut.add("UGA", 'W');
				/* Ter */
                ut.add("AGA", AminoAcids.TERMINATE_CHARACTER);
                ut.add("AGG", AminoAcids.TERMINATE_CHARACTER);
				/* Met */
                ut.add("AUA", 'M');
                return ut;
            }
...
class UniversalTranslator implements CodonTable {
    ...
    public int getOrganismTypeID() {
        return organismTypeID_;
    }

    protected void setOrganismTypeID(int id) {
    ...
    public UniversalTranslator() {
        ...
        //Ter
        add("UAA", AminoAcids.TERMINATE_CHARACTER);
        add("UAG", AminoAcids.TERMINATE_CHARACTER);
