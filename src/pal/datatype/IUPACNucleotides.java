...
//==========================================================
    ...
    static {
        ...
        final int A = Nucleotides.A_STATE;
        final int C = Nucleotides.C_STATE;
        final int G = Nucleotides.G_STATE;
        final int T = Nucleotides.UT_STATE;
		/* 0, A */
        d[0][A] = 1.0;
        b[0][A] = true;
        s[0] = new int[]{A};
        ...
        s[9] = new int[]{C, T};
		/* 10, CGT */
        d[10][C] = d[10][G] = d[10][T] = 1.0;
        b[10][C] = b[10][G] = b[10][T] = true;
        s[10] = new int[]{C, G, T};
		/* 11, AGT */
        d[11][A] = d[11][G] = d[11][T] = 1.0;
        b[11][A] = b[11][G] = b[11][T] = true;
        s[11] = new int[]{A, G, T};
		/* 12, ACT */
        d[12][A] = d[12][C] = d[12][T] = 1.0;
        b[12][A] = b[12][C] = b[12][T] = true;
        s[12] = new int[]{A, C, T};
		/* 13, ACG */
        d[13][A] = d[13][C] = d[13][G] = 1.0;
        b[13][A] = b[13][C] = b[13][G] = true;
        s[13] = new int[]{A, C, G};
		/* 14, ACGT */
