...
public class GeneralRateDistributionSubstitutionModel extends Parameterized.ParameterizedUser implements SubstitutionModel {
    ...
    public double[] getMatrixParameters() {
        return parameterization_.getBaseParameters(handler_);
    }

    public double[] getRateDistributionParameters() {
        return parameterization_.getBaseParameters(rateDistribution_);
    }
    ...
    public int getNumberOfTransitionCategories() {
        return rateDistribution_.getNumberOfRates();
    }

    public double getTransitionCategoryProbability(int category) {
        return rateDistribution_.getCategoryProbability(category);
    }

    public double[] getTransitionCategoryProbabilities() {
        return rateDistribution_.getCategoryProbabilities();
    }

    public double[] getEquilibriumFrequencies() {
        return handler_.getEquilibriumFrequencies();
    }
