...
// ============================================================================
    ...
    abstract public static class ParameterizedBase extends PalObjectListener.EventGenerator {
        ...
        public double getLowerLimit(int n) {
            return lowerLimits_[n];
        }

        public double getUpperLimit(int n) {
            return upperLimits_[n];
        }
