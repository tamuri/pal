...
public final class NexusTokenizer {
     ...
     * @throws IOException         I/O errors
     * @throws NexusParseException Parsing errors
     */
     ...
     * (i.e. no more tokens to read)
     * @throws IOException         I/O errors
     * @throws NexusParseException Thrown by parsing errors or if
    ...
    private synchronized String readHeaderToken() throws IOException, NexusParseException {
        ...
        c = (char) pr.read();
        if (c != 'N' && c != 'n') {
            throw new NexusParseException("Error: malformed NEXUS header at col:" + col + ", row:" + row);
        } else {
            sb.append(c);
            col++;
        }
