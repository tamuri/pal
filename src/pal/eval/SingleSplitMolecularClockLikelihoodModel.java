...
//			System.out.println("**** ASCENDENT 2************");
         ...
         */
        public double calculateLogLikelihoodNonRoot (double nodeHeight,
                                                     PatternInfo centerPattern,
...
// -=-=--==-=-=-=---=-==-=--==-=-=-=-
    ...
    private static final class SimpleInstance implements Instance, java.io.Serializable {
        ...
        public String getSubstitutionModelSummary() {
            return "Model:" + totalModel_.getSummary();
        }
...
// =================================================================================================
    private final static class TotalModel implements java.io.Serializable, NeoParameterized {
        ...
        public final int getNumberOfTransitionCategories() {
            return combineModel_.getNumberOfTransitionCategories();
        }

        public final double[][] getBaseCategoryProbabilities() {
            return probabilityModel_.getDistributionInfo();
        }

        public final CombineModel getCombineModel() {
            return combineModel_;
        }

        public String getSummary() {
            return "Distribution:" + probabilityModel_ + "\nModel:" + combineModel_.getSummary();
        }
...
// =================================================================================================
    private final static class CombineModel implements SubstitutionModel, java.io.Serializable, NeoParameterized {
        ...
        public final double getAdjustedDistance(double beforeSplitBaseHeight) {
            return beforeSplitBaseHeight - afterSplitBaseHeight_;
        }

        //For NeoParameterized interface
        public int getNumberOfParameters() {
            return parameters_.getNumberOfParameters();
        }
        ...
        public double getLowerLimit(int n) {
            return parameters_.getLowerLimit(n);
        }

        public double getUpperLimit(int n) {
            return parameters_.getUpperLimit(n);
        }
...
//For Parameterized interface (legacy stuff, that we don't use)
        ...
        public int getNumberOfTransitionCategories() {
            return numberOfTransitionCategories_;
        }

        public double getTransitionCategoryProbability(int category) {
            checkRebuild();
            return overallCategoryProbabilities_[category];
        }
