...
public final class ConditionalProbabilityStore implements java.io.Serializable {
    ...
    public final boolean isHasExtraProcessor() {
        return extraProcessor_ != null;
    }

    public final ExtraProcessor getExtraProcessor() {
        return extraProcessor_;
    }
    ...
    private void ensureSize(int numberOfPatterns, boolean createStateArray) {
        if (numberOfPatterns > patternCapacity_) {
            ...
            if (extraProcessor_ != null) {
                extraProcessor_.setNewNumberOfPatterns(numberOfPatterns);
            }
    ...
    public String toString() {
        return toString(patternCapacity_);
    }
