    ...
    private static final class ExternalImpl extends AbstractExternal implements External {
        ...
        private double[][] getResultStoreValues(double distance,
            ...
            for (int pattern = 0; pattern < numberOfPatterns; pattern++) {
                ...
                final double[] sa0 = transitionProbabilityStore_[0];
                final double[] sa1 = transitionProbabilityStore_[1];
                final double[] sa2 = transitionProbabilityStore_[2];
                final double[] sa3 = transitionProbabilityStore_[3];
